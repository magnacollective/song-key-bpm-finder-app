            ...
            <CardContent sx={{flex: '1 0 auto', paddingBottom: '16px !important'}}>
                <Grid container spacing={2}>
                    <Grid item md={3} sm={2} xs={12} mt={1}>
                        <img unoptimized className={styles.artwork} alt={track.artists && track.artists[0].name+' - '+track.name} width={170} height={ 170} src={track.album?.images[0] && track.album.images[0].url} />
                    </Grid>
